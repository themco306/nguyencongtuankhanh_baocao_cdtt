        ...
        <form action="{{ route('site.placeorder') }}" method="post">
            ...
            <div class="row">
                <div class="checkout-breadcrumbs text-center">
                    ...
                    <a style="color: #46423E!important" href="{{ route('site.checkout') }}" class="fs-5">CHI TIẾT THANH
                        TOÁN >
                    </a>
                ...
                <div class="col-md-7 right-content">
                    ...
                    <div class="p-3 ">
                        ...
                        <div class="row">
                            <p class="text-warning m-1">Nếu bạn đặt hàng cho chính mình thì không cần phải thay đổi thông
                                tin</p>
                            <div class="col-12 my-2">
                                <label for="name">Họ và tên( <span style="font-weight: 100">bạn nên chọn tên gọi dễ đọc
                                        để
