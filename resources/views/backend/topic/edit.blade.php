...
<section class="content">
        <div class="content-wrapper">
            ...
            <!-- Main content -->
            <section class="content">
                <form action="{{ route('topic.update',['topic'=>$topic->id]) }}" name="form1" method="post" enctype="multipart/form-data">
                    @method('PUT')
                <!-- Default box --> @csrf
                <div class="card">
                        ...
                        <div class="row">
                            ...
                            <div>
                                ...
                                <textarea name="metadesc" id="metadesc" class="form-control"
                                    placeholder="Mô tả"> {{ old('metadesc',$topic->metadesc) }}</textarea>
                                </div>
