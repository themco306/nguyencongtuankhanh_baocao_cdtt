...
@section('content')
    <section class="content">
        <div class="content-wrapper">
            ...
            <!-- Main content -->
            <section class="content">
                <form action="{{ route('product.store_sale') }}" name="form1" id='form_store' method="post" >
                    <!-- Default box --> @csrf
                    <div class="card">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div >
                                        <div class="clo-6">
                                            ...
                                            <input name="date_begin" id="date_begin" type="datetime-local" class="form-control" value="{{ old('date_begin') }}" min="{{ date('Y-m-d\TH:i') }}">
                                    ...
                                    <div >
                                        ...
                                        <input name="discount" id="discount" type="number" class="form-control" value="{{ old('discount') }}">
